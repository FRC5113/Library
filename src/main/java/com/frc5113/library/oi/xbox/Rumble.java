...
public class Rumble {
  ...
  /**
   * Update the rumble on both the left and right side To update individually, use setRumbleRight or
   * setRumbleLeft
   *
  ...
  /**
   * Update the rumble on <b>only</b> the right To update both, use setRumble
   *
   * @param newRight new right rumble value
   */
  ...
  /**
   * Update the rumble on <b>only</b> the left To update both, use setRumble
   *
   * @param newLeft new left rumble value
   */
