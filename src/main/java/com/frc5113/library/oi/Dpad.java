...
public class Dpad {
  ...
  /**
   * Define the value on the POV hat (DPad) at which the dpad direction is activated. This can be
   * though of as passing a threshold, at which that button is active <code>
   *     .value
   * </code> return the value on the hat.
   */
