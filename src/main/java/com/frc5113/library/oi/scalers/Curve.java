...
public abstract class Curve {
   ...
   * proportionally. <br>
   * <br>
   * A deadband or dead-band (also known as a dead zone or a neutral zone) is a band (value range)
   * of input values in the domain of a transfer function in a control system or signal processing
   * system where the output is zero (the output is 'dead' - no action occurs). - Wikipedia
   *
  ...
  /**
   * Prints the values of a 2D double array of points. The output of this method can be pasted into
   * <a href="https://www.desmos.com/calculator">Desmos</a> to see a visual representation of the
   * <code>points</code> on the <code>Curve</code>.
   *
   ...
   * method can be pasted into <a href="https://www.desmos.com/calculator">Desmos</a> to see a
   * visual representation of the <code>Curve</code>.
   *
  ...
  /**
   * Returns the value of <code>scalar</code>, the double value multiplied to the curve before it is
   * offset.
   *
  ...
  /**
   * Returns the value of <code>deadDiameter</code>, the value for the width in the center of the
