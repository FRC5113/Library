 ...
 *
 * An example can be found on <a href="https://www.desmos.com/calculator/du1hojvpm8">Desmos</a>.
 *
...
public class NoOpCurve extends Curve {
    /**
     * Constructs an No Op Curve object which can
     * be used in place of a curve to do nothing (y = x).
