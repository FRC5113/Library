...
public class FalconTankDrivetrain extends SmartSubsystem {
     ...
     */
    public FalconTankDrivetrain(int leftParentId, int rightParentId, int leftChildId, int rightChildId, double deadBand, double rampRate, NeutralMode neutralMode, double gearRatio, double outputDiameter) {
        super();
    ...
    /**
     * Create tank with default parameters (deadband = 0.1), but a custom neutral mode, motor ramp rate, gear ratio, output diameter.
     * <p> Location is based on the forward moving direction of the robot (stand facing the same way the front of the robot is facing)
     *
     * @param leftParentId   CAN ID of left parent
     * @param rightParentId  CAN ID of right parent
     ...
     * @param outputDiameter Diameter of the output wheel
     */
    public FalconTankDrivetrain(int leftParentId, int rightParentId, int leftChildId, int rightChildId, double rampRate, NeutralMode neutralMode, double gearRatio, double outputDiameter) {
        this(leftParentId, rightParentId, leftChildId, rightChildId, 0.1, rampRate, neutralMode, gearRatio, outputDiameter);
    }

    /**
     * Create tank with default parameters (deadband = 0.1, ramp_rate = 0.1), but a custom neutral mode, gear ratio, output diameter.
     * <p> Location is based on the forward moving direction of the robot (stand facing the same way the front of the robot is facing)
     *
     * @param leftParentId  CAN ID of left parent
     * @param rightParentId CAN ID of right parent
     ...
     * @param outputDiameter Diameter of the output wheel
     */
    public FalconTankDrivetrain(int leftParentId, int rightParentId, int leftChildId, int rightChildId, NeutralMode neutralMode, double gearRatio, double outputDiameter) {
        this(leftParentId, rightParentId, leftChildId, rightChildId, 0.1, 0.1, neutralMode, gearRatio, outputDiameter);
    }
     ...
     * @param outputDiameter Diameter of the output wheel
     */
    public FalconTankDrivetrain(int leftParentId, int rightParentId, int leftChildId, int rightChildId, double gearRatio, double outputDiameter) {
        this(leftParentId, rightParentId, leftChildId, rightChildId, 0.1, 0.1, NeutralMode.Coast, gearRatio, outputDiameter);
    }

    /**
     * Create tank with default parameters (deadband = 0.1, ramp_rate = 0.1, neutral_mode = coast, gear_ratio = 1, output_diameter = 1).
     * <p> Location is based on the forward moving direction of the robot (stand facing the same way the front of the robot is facing)
     *
     * @param leftParentId  CAN ID of left parent
     * @param rightParentId CAN ID of right parent
     ...
     * @param rightChildId  CAN ID of right child
     */
    public FalconTankDrivetrain(int leftParentId, int rightParentId, int leftChildId, int rightChildId) {
    ...
    public boolean checkSubsystem() {
        ...
        if (rpStatus && lpStatus && rcStatus && lcStatus && gyroStatus) {
            ...
            System.out.println("Drivetrain FAIL: Right Parent: " + rpStatus + "; Left Parent: " + lpStatus + "; Right Child: "  + rcStatus + "; Left Child: "  + lcStatus + "; Gyro: "  + gyroStatus);
            return false;
        }
    }
