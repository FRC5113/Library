...
/**
 * Utility class to speed up work with the "fruit camera" Limelight. <br>
 * <br>
 * The Limelight Class was started by Corey Applegate of Team 3244 Granite City Gearheads. We Hope
 * you enjoy the Limelight camera. Further modifications by Spectrum and the Combustible Lemons.
 *
...
public class Limelight {
  ...
  /**
   * tl The pipeline’s latency contribution (ms). Make sure to add at least 11ms for image capture
   * latency.
   *
   * @return latency (ms)
   */
   ...
   * <ul>
   *   <li>kVision
   *   <li>kDriver (Increases exposure, disables vision processing)
   * </ul>
   *
   ...
   *
   * @param pipeline Integer value of preferred pipeline: 0 - 9 Select pipeline 0-9
   */
   ...
   *
   * <ul>
   *   <li>kStandard - Side-by-side streams if a webcam is attached to Limelight
   *   <li>kPiPMain - The secondary camera stream is placed in the lower-right corner of the primary
   *       camera stream
   *   <li>kPiPSecondary - The primary camera stream is placed in the lower-right corner of the
  ...
  /**
   * snapshot Allows taking a camera render up to 2 times per second. Value <b>MUST</b> be set to
   * zero after each snapshot to take another snapshot, see: <br>
   * <br>
   * Fix "snapshot" networktables key. Users must set the "snapshot" key to "0" before setting it to
   * "1" to take a screenshot. (Bug fix changelog 2022.2.3 (3.16.22)) <br>
   * <br>
   * <br>
   * <br>
