...
/**
 * The {@link SmartTimedRobot} abstract class provides additional scaffolding to the Timed Robot
 * class. Its goal is to ensure that any robot code contains additional modifiers that are required
 * by libraries to function. While there are no implementation details, they are required (due to
 * the abstract clause) to be @Override-ed in the Robot class. <br>
 * <br>
 * Make sure to update SmartLoggedTimedRobot when updating this class
 *
 * <p><b>It is important to call super.{methodName} for background changes.</b>
 *
...
public abstract class SmartTimedRobot extends TimedRobot implements StatefulRobot {
  ...
  public static Alert notMainBotAlert =
